...
data = [normrnd(0,1.5,[25 1]),normrnd(0,1.5,[25 1]);
        normrnd(0,1.5,[25 1]),normrnd(8,1.5,[25 1]);
        normrnd(8,1.5,[25 1]),normrnd(0,1.5,[25 1]);
        normrnd(8,1.5,[25 1]),normrnd(8,1.5,[25 1])];
dl = length(data);
%plot(data(:,1),data(:,2),'*');
...
%% start iterations - perform following steps for each ANT
%  %  disp('game on!!');
